...
def EGA_optmize(Dim, gene_len, problem, random_Pop, NIND, Max_iter, intercept):
    base_fitness = benchmark.base_fitness(random_Pop, problem, intercept)
    problem = DProblem.MyProblem(Dim, gene_len, problem, random_Pop, intercept, base_fitness)
